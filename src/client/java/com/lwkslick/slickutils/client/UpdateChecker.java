...
public class UpdateChecker {
    ...
    private static final String MOD_ID        = "slickutils";
    private static final String MODRINTH_SLUG = "slickutils";
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                if (!latest.equals(current)) {
                    scheduleMessage("§e[SlickUtils] §fUpdate available: §7v" + current
                            + " §f→ §av" + latest
